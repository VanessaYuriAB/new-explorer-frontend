...
function useApiError(handleOpen) {
  return (error) => {
    ...
    const message =
      error.status === 429
        ? 'Foram feitas muitas solicitações para o servidor da página e ele bloqueou o acesso por este computador, por questão de segurança. Você pode continuar a pesquisar notícias em alguns minutos.'
        : error.message || 'Erro ao salvar ou des-salvar o artigo.';
