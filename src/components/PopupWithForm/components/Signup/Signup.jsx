  ...
  return (
    <>
      <form className="popup__signup">
        ...
        <label className="popup__signup-label" for="input-email">
          E-mail
        </label>
        <input
        ...
        <label className="popup__signup-label" for="input-password">
          Senha
        </label>
        <input
          className="popup__signup-input"
        ...
        <label className="popup__signup-label" for="input-name">
          Nome de usuário
        </label>
        <input
          className="popup__signup-input"
